...
class Tablelist extends React.Component {
    ...
    componentDidMount() {
        axios.get("http://localhost:8092/product/productlist")
            .then((res) => {
                this.setState({
                    product: res.data,
                    productid: 0,
    ...
    submit(event, productid) {
        ...
        if (productid === 0) {
            axios.post("http://localhost:8092/product/addproduct", {
            ...
            axios.put("http://localhost:8092/product/productupdate", {
    ...
    delete(productid) {
        axios.delete(`http://localhost:8092/product/productdelete/${productid}`)
            .then(() => {
                this.componentDidMount();
            })
    }
    edit(productid) {
        axios.get(`http://localhost:8092/product/productview/${productid}`)
            .then((res) => {
